      ...
      const pendingResources = [...images, ...buffers].map(function (resource) {
        try {
          ...
          return Promise.resolve(_catch(function () {
            ...
            if (!_this8._strictResources && images.includes(resource)) {
              _this8._logger.warn(`Failed to load image URI, "${uri}". ${error}`);
...
class NodeIO extends PlatformIO {
  ...
  init() {
    try {
      ...
      return Promise.all([Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('fs')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('path')); })]).then(([fs, path]) => {
