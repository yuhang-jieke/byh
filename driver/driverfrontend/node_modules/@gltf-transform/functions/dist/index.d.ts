...
export { type DequantizeOptions, dequantize, dequantizePrimitive } from './dequantize.js';
export { cloneDocument, copyToDocument, createDefaultPropertyResolver, mergeDocuments, moveToDocument, } from './document-utils.js';
...
export { assignDefaults, createTransform, fitPowerOfTwo, fitWithin, getGLPrimitiveCount, isTransformPending, } from './utils.js';
