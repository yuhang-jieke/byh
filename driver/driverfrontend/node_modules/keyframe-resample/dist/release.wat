(module
 ...
 (type $6 (func (param i32 i32 i32 f32) (result i32)))
   ...
   if
    ...
    if (result i32)
     ...
     if (result i32)
      ...
      f32.add
      local.set $5
      block $__inlined_func$assembly/resample/eq$2 (result i32)
       i32.const 0
       local.set $8
       i32.const 0
       local.get $24
       ...
       i32.shr_u
       i32.ne
       br_if $__inlined_func$assembly/resample/eq$2
       drop
       loop $for-loop|00
        local.get $7
        local.get $8
      ...
      if (result i32)
       ...
       block $__inlined_func$assembly/resample/eq$3 (result i32)
        i32.const 0
        local.set $7
        i32.const 0
        local.get $24
        ...
        i32.shr_u
        i32.ne
        br_if $__inlined_func$assembly/resample/eq$3
        drop
        loop $for-loop|01
         local.get $7
         local.get $8
       ...
       if (result i32)
        ...
        block $__inlined_func$assembly/resample/eq$4 (result i32)
         i32.const 0
         local.set $7
         i32.const 0
         local.get $24
         ...
         i32.shr_u
         i32.ne
         br_if $__inlined_func$assembly/resample/eq$4
         drop
         loop $for-loop|02
          local.get $7
          local.get $8
        ...
        if (result i32)
         block $__inlined_func$assembly/resample/eq$5 (result i32)
          i32.const 0
          local.set $7
          i32.const 0
          local.get $24
          ...
          i32.shr_u
          i32.ne
          br_if $__inlined_func$assembly/resample/eq$5
          drop
          loop $for-loop|07
           local.get $7
           local.get $8
